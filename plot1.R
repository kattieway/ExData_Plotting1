...
#filterind data from the dates 2007-02-01 and 2007-02-02
date <- as.Date(data$Date, "%d/%m/%Y")
filter_date <- subset(data,date >= as.Date('2007-2-1') & date <= as.Date('2007-2-2'))

#making the 1-st plot
hist(filter_date$Global_active_power, main = 'Global Active Power', 
     col = 'red', xlab = 'Global Active Power (kilowatts)')

#saving histogram in .png
